...
instance_create_layer(irandom_range(spawnPointX-spawnRangeX,spawnPointX+spawnRangeX),irandom_range(spawnPointY-spawnRangeY,spawnPointY+spawnRangeY),"Instances",choose(obj_squareStar,obj_recStar));
